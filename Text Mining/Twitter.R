...
### authentication
user <- OAuthFactory$new(consumerKey="_______________________________________________",##consumer API key
                         consumerSecret="____________________________________________",##consumer API secret key
